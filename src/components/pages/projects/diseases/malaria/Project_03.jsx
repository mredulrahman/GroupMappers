  ...
  return (
    <>
      ...
      <div className='bg-[#000B58] text-center py-1'>
          <h3 className='font-[600] text-white text-2xl'>Piloting Village-level Malaria Surveillance in Lama, Bandarban.</h3>
      </div>
      <section className='bg-gradient-to-r from-cyan-100 to-sky-50'>
        ...
        <div className='flex flex-col gap-4 items-center'>
          <img src="/src/assets/images/image_2023_04_12T08_05_07_050Z.png" alt="" className='md:w-4xl md:p-2' />
            <div className='grid md:grid-cols-2 gap-4 md:mx-[170px] p-3'>
