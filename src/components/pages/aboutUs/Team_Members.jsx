  ...
  return (
    <>
      ...
      <div className='bg-[#000B58] text-center py-1'>
        <h3 className='font-[600] text-white text-2xl'>Meet our team members </h3>
      </div>
      <section className="bg-radial-[at_15%_35%] from-cyan-200 via-sky-100 via-45% to-blue-300 to-95% grid md:grid-cols-2 gap-9 md:p-16">
